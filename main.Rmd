...
This article aims to accomplish [Classification in Machine Learning 1](https://algorit.ma/course/classification-1/) course at Algoritma. The dataset used is obtained from [the University of California at Irvine Machine Learning Repository](https://archive.ics.uci.edu/ml/datasets/Cervical+cancer+%28Risk+Factors%29#), "Cervical cancer (Risk Factors)". You could see the source code fully in my GitHub account [here](https://github.com/utomoreza/C1_LBB).
...
GGally::ggcorr(sonar %>% select(-type))
